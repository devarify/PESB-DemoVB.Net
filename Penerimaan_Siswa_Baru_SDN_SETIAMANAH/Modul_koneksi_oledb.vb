...
Public Class koneksi
    ...
    Public Function OpenConn() As Boolean
        Cn = New OleDb.OleDbConnection("Provider=SQLOledB;Integrated Security=SSPI;Persist Security Info=False;Initial catalog=db_PSB_Setiamanah;data source=PC-1056\SQLEXPRESS")
        Cn.Open()
