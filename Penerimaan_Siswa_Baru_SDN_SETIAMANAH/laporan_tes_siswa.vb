...
Public Class laporan_tes_siswa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penerimaan_Siswa_Baru_SDN_SETIAMANAH.laporan_tes_siswa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_tes_siswa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_tes_siswa = New laporan_tes_siswa()
        rpt.Site = Me.Site
        Return rpt
    End Function
