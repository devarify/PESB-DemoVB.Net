...
Public Class laporancalonsiswa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penerimaan_Siswa_Baru_SDN_SETIAMANAH.laporancalonsiswa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporancalonsiswa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporancalonsiswa = New laporancalonsiswa()
        rpt.Site = Me.Site
        Return rpt
    End Function
