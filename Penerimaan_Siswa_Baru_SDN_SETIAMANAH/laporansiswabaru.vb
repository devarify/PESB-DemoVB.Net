...
Public Class laporansiswabaru
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penerimaan_Siswa_Baru_SDN_SETIAMANAH.laporansiswabaru.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporansiswabaru
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporansiswabaru = New laporansiswabaru()
        rpt.Site = Me.Site
        Return rpt
    End Function
