...
Public Class laporantessiswa1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Penerimaan_Siswa_Baru_SDN_SETIAMANAH.laporantessiswa1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporantessiswa1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporantessiswa1 = New laporantessiswa1()
        rpt.Site = Me.Site
        Return rpt
    End Function
